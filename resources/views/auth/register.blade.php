          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="/images/auth/unair.png" alt="logo">
              </div>
              <h4>New here?</h4>
              ...
              <form method="POST" action="{{ route('register') }}" class="pt-3">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="role" placeholder="Role" name="id_jenis_user" required>
                        @foreach($jenisusers as $jenisuser)
                        @if($jenisuser->jenis_user == 'mahasiswa' || $jenisuser->jenis_user == 'dosen')
